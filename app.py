...
st.set_page_config(page_title="vedText ", page_icon=":robot:")
...
with st.sidebar:
    ...
    image = Image.open('vedText.jpg')
    st.image(image)
    st.markdown("<h3 style='text-align: left'> Intelligent PDF Summarizer and Inquiry Companion </h3>", unsafe_allow_html= True)
    st.markdown("""
            <br><p style='text-align: left;'>With vedText, you can quickly obtain concise and accurate summaries of lengthy documents, saving valuable time. \
            ...
            and hello to a seamless exploration of knowledge with vedText as your trusted companion.</p> <br><br>
